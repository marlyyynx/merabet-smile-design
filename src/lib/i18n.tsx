...
const dictionaries: Record<Lang, Dict> = {
  en: {
    ...
    "contact.hoursVal": "Sunday – Saturday (closed Friday) · 9:00 – 19:00",
  ...
  fr: {
    ...
    "contact.hoursVal": "Dimanche – Samedi (fermé vendredi) · 9h00 – 19h00",
  ...
  ar: {
    ...
    "contact.hoursVal": "الأحد – السبت (مغلق الجمعة) · 9:00 – 19:00",
